...
public partial class CodeCompiler
{
    ...
    protected MethodDefinitionHandle RoutineDeclarationNodeVisitor(
        RoutineDeclarationNode node, CodegenContext context)
    {
    ...
    protected int StoreLocalVariable(
        string variableName, CodegenContext context,
        Action? loadAction = null, Action? storeAction = null
    )
    {
    ...
    protected void ForLoopVisitor(ForLoopNode loop, CodegenContext context)
    {
        ...
        void StoreAction() => throw new TargetException(
