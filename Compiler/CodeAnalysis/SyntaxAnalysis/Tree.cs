...
namespace Compiler.CodeAnalysis.SyntaxAnalysis
{
    public class Tree
    {
        ...
        public Tree(ProgramNode root) => Root = root;
    ...
    public abstract class Node
    {
        ...
        public override string ToString() => ToString(new StringBuilder(), isLast: true, string.Empty).ToString();
        ...
        private StringBuilder ToString(StringBuilder builder, bool isLast, string indent)
        {
            ...
            {
                builder.Length -= 2;
                if (leaf.Kind != null) builder.Append($": {leaf.Kind.GetDescription()}");
                builder.Append(' ');
    ...
    public abstract class DeclarationNode : Node
    {
        ...
        protected DeclarationNode(IdentifierNode identifier) => Identifier = identifier;
    }
    ...
    public class RoutineDeclarationNode : DeclarationNode
    {
        ...
        public RoutineDeclarationNode(IdentifierNode identifier, TypeNode? returnType, ListNode<ParameterDeclarationNode> parameters, BodyNode body)
            : base(identifier)
        {
    ...
    public class RecordTypeNode : TypeNode
    {
        ...
        public override IEnumerable<Node> GetChildren() =>
            GetChildren(Members, Identifier);

        public RecordTypeNode(IdentifierNode identifier, ListNode<VariableDeclarationNode> members)
            : base(TypeKind.Record, identifier) =>
    ...
    public class ModifiablePrimaryNode : PrimaryNode
    {
        ...
        public ModifiablePrimaryNode(IdentifierNode? identifier, ModifiablePrimaryNode? prev = null, ExpressionNode? index = null)
        {
            Identifier = identifier;
            Prev = prev;
            Index = index;
